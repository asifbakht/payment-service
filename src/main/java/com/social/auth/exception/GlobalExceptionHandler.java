...
import static com.social.auth.utils.Constants.DELIMETER_COMMA;
...
public class GlobalExceptionHandler {
   ...
   /**
    * exception handler when specific resource not found in db
    * 
   ...
   /**
    * exception handler when user with same email address exists in database
    * 
   ...
   /**
    * exception handler that throw exception to terminate the process
    * when any unexpected event occurs.
    *
